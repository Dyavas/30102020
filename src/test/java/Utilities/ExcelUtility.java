...
public class ExcelUtility {
    public static List<List<String>>   getListData(String path,String sheetName,int columunCount  ){
        ...
        for (int i = 0; i <rowcount ; i++) {
            ...
            int colltotal=row.getPhysicalNumberOfCells();
            if (columunCount>colltotal) columunCount=colltotal;
    ...
    public static void main(String[] args) {
          List<List<String>> gelenlist=getListData("src/main/resources/ApacheExcel1.xlsx","Tabelle2",10);
        System.out.println("gelenlsit = " + gelenlist);
    gelenlist=getListData("src/main/resources/ApacheExcel1.xlsx","Tabelle2",2);
        System.out.println("gelenlsit = " + gelenlist);
    }
}
